...
class RepairTransferRequest(models.Model):
    _name = 'repair.transfer.request'
    _description = 'Repair Transfer Request'
    ...
    source_company_id = fields.Many2one(related='repair_id.company_id', string='Source Institution', store=True, readonly=True)
